	...
	return (
		<div className={twMerge("relative", className)} ref={ref}>
			<button
				...
				{icon}
				{selected}
				<span className="ml-[0.255em] inline-block border-x-[0.3em] border-b-0 border-t-[0.3em] border-solid border-accentDark-700 border-x-transparent align-[0.255em] group-hover:border-y-white group-focus-visible:after:border-y-white"></span>
			</button>
			{open && (
